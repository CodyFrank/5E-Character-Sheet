...
c = Character.create(
    {
        ...
        level_two_spell_slots: nil,
        level_three_spell_slots: nil,
        level_four_spell_slots: nil, 
        level_five_spell_slots: nil,
        level_six_spell_slots: nil, 
        level_seven_spell_slots: nil, 
        level_eight_spell_slots: nil, 
        level_nine_spell_slots: nil,
        level_one_used_spell_slots: 0,
        level_two_used_spell_slots: nil,
        level_three_used_spell_slots: nil, 
        level_four_used_spell_slots: nil, 
        level_five_used_spell_slots: nil, 
        level_six_used_spell_slots: nil, 
        level_seven_used_spell_slots: nil,
        level_eight_used_spell_slots: nil, 
        level_nine_used_spell_slots: nil
    }
)
